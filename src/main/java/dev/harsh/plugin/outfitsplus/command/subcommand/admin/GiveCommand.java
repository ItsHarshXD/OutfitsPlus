...
public final class GiveCommand implements SubCommand {
    ...
    public GiveCommand(OutfitsPlus plugin) {
    ...
    public List<String> getAliases() {
        return List.of("grant", "unlock");
    }

    @Override
    public String getDescription() {
        return "Give a cosmetic to a player";
    }

    @Override
    public String getUsage() {
        return "/outfits give <player> <category> <id>";
    }

    @Override
    public String getPermission() {
        return "outfitsplus.admin.give";
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (data.hasUnlocked(cosmeticId)) {
            ...
            localeManager.sendMessage(sender, MessageKey.ADMIN_GIVE_ALREADY_HAS,
        ...
        String name = localeManager.getCosmeticName(sender, cosmeticId, category.name());
        localeManager.sendMessage(sender, MessageKey.ADMIN_GIVE_SUCCESS,
                "player", target.getName(),
                "cosmetic", name);
    }
